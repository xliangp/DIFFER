...
from timm.models.helpers import named_apply, checkpoint_seq, adapt_input_conv
from timm.models.registry import generate_default_cfgs, register_model #, register_model_deprecations
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor,cam_label) -> torch.Tensor:
...
def _create_vision_transformer(variant: str, pretrained: bool = False, config={},camera_num=0,**kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch32_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch32_clip_256_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch32_clip_384_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch32_clip_448_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch16_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch16_clip_384_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_large_patch14_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_large_patch14_clip_336_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_336_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_378_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_giant_patch14_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_gigantic_patch14_clip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_base_patch32_clip_quickgelu_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ ViT-B/32 CLIP image tower @ 224x224
    """
    model_args = dict(
...
@register_model
def vit_base_patch16_clip_quickgelu_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_large_patch14_clip_quickgelu_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_large_patch14_clip_quickgelu_336_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_quickgelu_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def vit_huge_patch14_clip_quickgelu_378_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def eva_large_patch14_196_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
...
@register_model
def eva_large_patch14_336_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ EVA-large model https://arxiv.org/abs/2211.07636 via MAE MIM pretrain"""
    model_args = dict(patch_size=14, embed_dim=1024, depth=24, num_heads=16, global_pool='avg')
...
@register_model
def vit_base_patch16_siglip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, class_token=False, global_pool='avg',
    )
    model = _create_vision_transformer(
...
@register_model
def vit_base_patch16_siglip_256_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
...
@register_model
def vit_base_patch16_siglip_384_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, class_token=False, global_pool='map',
    )
    model = _create_vision_transformer(
...
@register_model
def vit_base_patch16_siglip_512_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, class_token=False, global_pool='map',
    )
    model = _create_vision_transformer(
...
@register_model
def vit_large_patch16_siglip_256_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
...
@register_model
def vit_large_patch16_siglip_384_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
        patch_size=16, embed_dim=1024, depth=24, num_heads=16, class_token=False, global_pool='map',
    )
    model = _create_vision_transformer(
...
@register_model
def vit_so400m_patch14_siglip_224_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
...
@register_model
def vit_so400m_patch14_siglip_384_bio(pretrained: bool = False, **kwargs) -> VisionTransformer:
    model_args = dict(
        patch_size=14, embed_dim=1152, depth=27, num_heads=16, mlp_ratio=3.7362, class_token=False, global_pool='map',
    )
    model = _create_vision_transformer(

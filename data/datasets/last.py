...
class LaST(object):
    ...
    def __init__(self, root='data',  **kwargs):
        ...
        self.num_test_query_pids = num_val_query_pids
        self.num_test_gallery_pids = num_val_gallery_pids
        self.pid2clothes = pid2clothes
        self.num_query_imgs = len(val_query)
        self.num_camera=1
